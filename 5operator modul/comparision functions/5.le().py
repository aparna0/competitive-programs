...
#1)operator.le(a,b)/ <= / operator.__le__(a,b)

print(op.le(1,1),op.le(1,2))                                        #true true

#print(op.le(1,None))                                               #TypeError: '<' not supported between  'int' and 'NoneType'

print(op.le(1.5,1),op.le(1.5,1.5),op.le(1.9,2.5))                   #false true true

print(op.le('abc','d'),op.le('abc','abc'))                          #true true

#print(op.le(1,'a'))                                                #TypeError: '<' not supported between  'int' and 'str'
...
print('ok',op.le(d1,d2),op.le(d1,d3),op.le(d4,d1))               #false false true (as it calls lt() method of Demo class).
